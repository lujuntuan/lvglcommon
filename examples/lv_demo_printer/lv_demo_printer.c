...
void lv_demo_printer(void)
{
    ...
    lv_theme_t* th = lv_demo_printer_theme_init(LV_COLOR_BLACK, LV_COLOR_BLACK,
        0, &lv_custom_font_14, &lv_custom_font_18,
        &lv_custom_font_24, &lv_custom_font_32);
    lv_theme_set_act(th);
...
static void lv_demo_printer_anim_bg(uint32_t delay, lv_color_t color, int32_t y_new)
{
    ...
    lv_anim_t a;
    if ((y_new == LV_DEMO_PRINTER_BG_NORMAL && y_new == y_act) || (y_new == LV_DEMO_PRINTER_BG_NORMAL && y_act == LV_DEMO_PRINTER_BG_FULL)) {
        lv_anim_path_t path;
