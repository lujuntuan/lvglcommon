...
#define LV_DISP_DEF_REFR_PERIOD      16      //FPS=60, interval=16.66667
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  "lv_custom/lv_custom.h"         /*Header for the system time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (lv_custom_tick_get())     /*Expression evaluating to current system time in ms*/
