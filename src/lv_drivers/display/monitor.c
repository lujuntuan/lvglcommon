...
{
    monitor_sdl_init();
    lv_task_create(sdl_event_handler, LV_DISP_DEF_REFR_PERIOD, LV_TASK_PRIO_HIGH, NULL);
}
...
static void window_create(monitor_t* m)
{
    m->window = SDL_CreateWindow("SDL Simulator",
        0, 0,
        MONITOR_HOR_RES * MONITOR_ZOOM, MONITOR_VER_RES * MONITOR_ZOOM, SDL_WINDOW_BORDERLESS /*| SDL_WINDOW_ALWAYS_ON_TOP*/); /*last param. SDL_WINDOW_BORDERLESS to hide borders*/
